...
export default function ChildGrades({
    ...
    const handleProgramChange = (programId: string) => {
        router.get(`/padre/hijo/${child.id}/calificaciones/${programId}`);
    };
    ...
    return (
        <AppLayout>
            <Head title={`Calificaciones de ${child.name}`} />
                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                    <div className="flex items-center gap-3">
                        <Button
                            variant="outline"
                            size="icon"
                            onClick={() => router.visit('/padre/dashboard')}
                        ...
                        <div className="text-center sm:text-left flex-1">
                            ...
                            <p className="text-muted-foreground mt-1 text-sm sm:text-base">
                                Revisa el progreso y calificaciones por programa
                            </p>
                        </div>
                    </div>
                    ...
                    <Card>
                        <CardContent className="py-8 sm:py-12 text-center">
                            ...
                            <p className="text-muted-foreground max-w-md mx-auto text-sm sm:text-base">
                                Elige uno de los programas académicos para ver las calificaciones
                            ...
                            <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
                                <Card>
                                    ...
                                    <CardContent className="p-3 sm:p-6 pt-0">
                                        <div className="text-xl sm:text-2xl font-bold">{programStats.overall_progress}%</div>
                                        <Progress value={programStats.overall_progress} className="mt-2 h-2" />
                                    </CardContent>
                                </Card>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="p-3 sm:p-6 pt-0">
                                        <div className={`text-xl sm:text-2xl font-bold ${getScoreColor(programStats.overall_average)}`}>
                                            {programStats.overall_average !== null ? `${programStats.overall_average}%` : 'N/A'}
                                        </div>
                                        <div className="mt-1">{getScoreBadge(programStats.overall_average)}</div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="p-3 sm:p-6 pt-0">
                                        <div className="text-xl sm:text-2xl font-bold">{programStats.total_modules}</div>
                        ...
                        <Card>
                            <CardHeader className="p-4 sm:p-6">
                                ...
                                <CardDescription className="text-xs sm:text-sm">
                                    Desglose del progreso por módulo y actividad
                                </CardDescription>
                            </CardHeader>
                                                                    ...
                                                                    <div className="flex items-start justify-between gap-2 mb-2">
                                                                        ...
                                                                        <div className="text-right flex-shrink-0">
                                                                            {activity.is_evaluated ? (
                                                                                ...
                                                                                <Badge variant="outline" className="text-[10px] sm:text-xs">Pendiente</Badge>
                                                                            )}
                                                                        </div>
                                                                    </div>
